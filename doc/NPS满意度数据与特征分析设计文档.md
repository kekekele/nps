...
有效评分必须为可转换成整数的 0-10。第 7 列“营销宣传满意度”的 0/100 指标不是 Q 题原始评分，不参与上述标签计算。
...
| `raw_value` | 原始值，供审计 |
| `score_value` | 清洗后的 0-10 整数 |
| `is_valid` | 是否有效评分 |
| `is_low_score` | 有效且为 0-6 |
